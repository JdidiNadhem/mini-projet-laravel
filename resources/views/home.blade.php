                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="/"><span>Présentation</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="/">STUDENT CONTEST</a></li>
                            <li><a href="/">EXHIBITORS</a></li>

                        </ul>
                    </li>
                    <li><a class="nav-link scrollto" href="index.html#portfolio">Committees</a></li>
                    <li><a class="nav-link scrollto" href="index.html#team">Sponsors</a></li>
                    <li class="dropdown"><a href="/"><span>Venue</span> <i
                                class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="/">HERAKILTON & CRETE</a></li>
                            <li><a href="/">CONFERENCE VENUE</a></li>
                            <li><a href="/">HOTELS</a></li>

                        </ul>
                    </li>
                    <li><a class="nav-link scrollto" href="index.html#team">Video & Photo</a></li>
            ...
            <div class="container" data-aos="zoom-out" style="margin-top: 100px;">
                ...
                <div class="row g-5">
                    ...
                    <div
                        ...
                        <h3>JOINT URBAN REMOTE SENSING EVENT</h3>
                        <p> Heraklion Crete, Greece <br /> 17 - 19 May 2023</p>
                    </div>

                    <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
                        <div class="img">
                            <img src="https://jurse2023.org/images/banner.png" alt="" class="img-fluid">
                        </div>
                    </div>
